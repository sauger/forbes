...
<?php
	...
	if($db->record_count==1){
		...
		$gp->save();
		$content = "{$name},你好：<br/><br/>　　欢迎进行福布斯中文网密码重置过程，请点击下面的链接：<br/>　　<a href='http://www.forbeschina.com/getpwd/get_pwd.php?verify=$verify'>http://www.forbeschina.com/getpwd/get_pwd.php?verify=$verify</a><br><br>　　如果点击以上链接不起作用，请将此网址复制并粘贴到新的浏览器窗口中。如果您意外地收到此邮件，很可能是其他用户在尝试重设密码时，误输入了您的电子邮件地址。如果您没有提出此请求，则无需做进一步的操作，可以放心地忽略此电子邮件。";
