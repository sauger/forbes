		...
		<div id="container-inner"><!-- container-inner begin -->
			<div id="header"><!-- header begin -->
				<div id="header-inner"><!-- header-inner begin -->
					<div class="header_bg" style="background:url(images/header-bg.gif);">
						<div style="float:left; margin-top:230px;">
							<a href="word.html">
								<img src="images/lcs_word.png">
							</a>
						</div>
					</div>						
							...
							<div class="background-warp">
								<div class="entryform-main">								
									<div class="entryform-box">
										...
										<p class="bg">保密承诺：组委会对所有问卷信息严格保密。在注册竞赛、调查及意见反馈时您输入的任何个人资料都将被收集并存储在数据库中，组委会将采取必要的防范措施确保您的个人资料不被丢失、滥用或篡改。只有经授权的组委会工作人员及委托人才有权使用该资料。除了本保密承诺中所指定的当事方以外，组委会工作人员和委托人不会向组委会以外的任何第三方透露这些资料。尽管如此，由于互联网的公开特征，我们无法完全保证储存在服务器上的，或传输自 / 向用户的任何信息免遭非法获取或篡改。参与此次活动表示您理解并同意承担这些风险。</p><p>*报名截止日期：9月8日<br>带“*”号的选项为必填项</p>
