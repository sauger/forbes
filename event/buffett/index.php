						...
						<div id="content-inner" class="clear"><!-- content-inner begin -->
							<div class="c-main">
								...
								<div class="text-box">
									...
									<?php }else{?>
									<p><a title="<?php echo $news->title;?>" href="<?php echo static_news_url($news);?>"><span>[<?php echo substr($news->created_at,0,10);?>]</span><?php echo mb_substr($news->title,0,13,'utf-8')?></a></p>
									<?php }}?>
								</div>
