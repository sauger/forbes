...
<body>
 <div id="ibody">		
	...
	<div id=register>
		...
		<div class="dash"></div>
		<div readonly="readonly" id="register_info">
<p><b>1、服务使用条款的接受</b><p>
<p>1.1 福布斯中文网站（以下简称“福布斯中文网”，域名为：www.forbeschina.com）为注册地和主营业地位于上海的智惠文化传播有限公司所独立拥有，福布斯中文网提供的服务完全按照其发布的服务条款和操作规则。上海的智惠文化传播有限公司享有对福布斯中文网上一切活动的监督、提示、检查、纠正及处罚等权利。服务使用人（以下称“用户”）在使用福布斯中文网提供的各项服务之前，应仔细阅读本用户协议。</p>
...
<p>福布斯中文网有权随时对服务条款进行修改，并且一旦发生服务条款的变动，福布斯中文网将在页面上提示修改的内容；当用户使用福布斯中文网的特殊服务时，应接受福布斯中文网随时提供的与该特殊服务相关的规则或说明，并且此规则或说明均构成本服务条款的一部分。用户如果不同意服务条款的修改，可以主动取消已经获得的网络服务；如果用户继续享用网络服务，则视为用户已经接受服务条款的修改。</p>
<p><b>3、服务说明</b></p>
<p>3.1 福布斯中文网网运用自己的操作系统通过国际互联网向用户提供丰富的网上资源，包括各种新闻信息、网上论坛、个性化内容（含博客、微博、相册）等服务（以下简称“本服务”）。除非另有明确规定，增强或强化目前服务的任何新功能，包括新产品，均无条件地适用本服务条款。</p>
...
<p>3.5 用户享有本站用户的各种权利，可享受本站提供的各项服务；用户同时有权对福布斯中文网管理提出批评、意见、建议；有疑问或者认为自己在福布斯中文网的权益受到侵害，可以向在线管理员或客服咨询或投诉。</p></p>
<p><b>4、用户应遵守以下法律及法规：</b></p>
<p>4.1 用户同意遵守中华人民共和国相关法律法规、规章及司法解释，包括但不限于《中华人民共和国计算机信息系统安全保护条例》、《计算机软件保护条例》、《最高人民法院关于审理涉及计算机网络著作权纠纷案件适用法律若干问题的解释(法释[2004]1号)》、《全国人大常委会关于维护互联网安全的决定》、《互联网电子公告服务管理规定》、《互联网新闻信息服务管理规定》、《互联网著作权行政保护办法》和《信息网络传播权保护条例》等有关计算机互联网规定和知识产权的法律和法规、实施办法。在任何情况下，福布斯中文网合理地认为用户的行为可能违反上述法律、法规、规章及司法解释，福布斯中文网可以在任何时候，经事先通知终止向该用户提供服务。</p>
<p>4.2 用户应了解国际互联网的无国界性，应特别注意遵守当地所有有关的法律和法规。</p></p> 
<p><b>5、用户隐私权制度</b></p>
<p>5.1 当用户注册福布斯中文网的服务时，用户须提供个人信息。福布斯中文网收集个人信息的目的是为用户提供尽可能多的个人化网上服务以及为广告商提供一个方便的途径来接触到适合的用户，并且可以发送具有相关性的内容和广告。在此过程中，广告商绝对不会接触到用户的个人信息。尊重用户个人隐私信息的私有性是福布斯中文网的重点原则，福布斯中文网将会采取合理的措施保护用户的个人隐私信息。福布斯中文网不会在未经合法用户授权时，公开、编辑或透露其个人信息及保存在福布斯中文网中的非公开内容，除非有下列情况： </p>
...
<p>a. 福布斯中文网可能会与合作方合作向用户提供相关的服务，在此情况下，如该合作方同意承担与福布斯中文网同等的保护用户隐私的责任，则福布斯中文网可将用户的注册资料等提供给该合作方； b.在不透露单个用户隐私资料的前提下，福布斯中文网有权对整个用户数据库进行分析并对用户数据库进行商业上的利用；</p>
...
<p>另外，福布斯中文网会竭尽全力保护用户的信息，但福布斯中文网不能确信或保证任何个人信息的安全性，用户须自己承担风险。比如用户联机公布可被公众访问的个人信息时，用户有可能会收到未经用户同意的消息；福布斯中文网的合作伙伴和可通过福布斯中文网访问的第三方因特网站点和服务得知用户个人信息的其他第三方会进行独立的数据收集工作等活动，福布斯中文网对用户及其他任何第三方的上述行为，不负担任何责任。</p></p>
...
<p>6.3 用户的密码和帐号遭到未授权的使用或发生其他任何安全问题，用户可以立即通知福布斯中文网，并且用户在每次连线结束，应结束帐号使用，否则用户可能得不到福布斯中文网的安全保护。</p></p>
...
<p><b>10、避风港原则</b></p>
<p>当第三方认为用户上传或者发表于福布斯中文网的信息侵犯其权利，并根据《信息网络传播权保护条例》或者相关法律规定向福布斯中文网发送权利通知书时，用户同意福布斯中文网可以自行判断决定删除涉嫌侵权的用户上传或者发表于福布斯中文网的信息，除非收到符合相关法律规定且可以证明福布斯中文网不承担任何法律责任的书面说明，福布斯中文网将不会自动恢复上述删除的信息。</p>
<p><b>11、赔偿责任</b></p>
<p>11.1 如用户在使用网络服务时违反上述任何规定，福布斯中文网有权要求用户改正或直接采取一切必要的措施（包括但不限于删除用户张贴的内容、回收用户账号、暂停或终止用户使用网络服务的权利）以减轻用户不当行为而造成的影响。因此导致福布斯中文网损失的，福布斯中文网有权保留相关记录并要求用户赔偿，用户所产生的一切损失自行承担。</p>
...
<p>12.2 用户对于其创作并在福布斯中文网公开使用区域张贴上的合法信息依法享有著作权及其相关权利；但这也同时意味着用户授权福布斯中文网在全世界范围内具有永久性的、不可撤销的权利和免许可费、可完全转授的权利。福布斯中文网有权为展示、散布及推广前述张贴的内容之服务目的，对上述内容进行复制、修改、改编、出版。用于平面出版等商业性用途时，将按同行业的稿费标准支付稿酬并于使用前先知会作者。 </p>
...
<p><b>18、免责声明</b></p>
<p>18.1 福布斯中文网对于任何包含、经由或连接、下载或从任何与有关本服务所获得的任何内容、信息或广告，不声明或保证其正确性或可靠性；并且对于用户经本服务上的广告、展示而购买、取得的任何产品、信息或资料，福布斯中文网不负保证责任。用户自行负担使用本服务的风险。</p>
...
<p>d. 其他与本服务相关的事宜。</p>
<p>18.7 互联网是一个开放平台，用户如将照片等个人资料上传到互联网上，有可能会被其他组织或个人复制、转载、擅改或做其它非法用途，用户必须充分意识此类风险的存在。用户明确同意其使用福布斯中文网服务所存在的风险将完全由其自己承担；因其使用福布斯中文网服务而产生的一切后果也由其自己承担，福布斯中文网对用户不承担任何责任。 </p>
<p><b>19、通知和送达</b></p>
...
<p><b>20、法律的适用和管辖</b></p>
<p>本服务条款的生效、履行、解释及争议的解决均适用中华人民共和国法律。本协议签订地为上海，如双方就本协议内容或其执行发生任何纠纷或争议，首先双方应尽量友好协商解决；协商不成时，用户在此完全同意将纠纷或争议提交福布斯中文网所在地即上海有管辖权的人民法院管辖。本服务条款因与中华人民共和国现行法律相抵触而导致部分无效，不影响其他部分的效力。 </p>
<p><b>21、其他规定</b></p>
