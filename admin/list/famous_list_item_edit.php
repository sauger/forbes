...
<body style="background:#E1F0F7">
	...
	<table width="795" border="0">
		...
		<tr class=tr4>
			<td width="130">职业</td>
			<td width="695" align="left">
				<input type="text" name="item[job]" value="<?php echo $item->job;?>"></input>
			</td>
		</tr>
		<tr class=tr4>
			<td>综合排名</td>
		...
		<tr class=tr4>
			<td width="130">收入排名</td>
			<td align="left">
				<input type="text" name="item[fortune_order]" value="<?php echo $item->fortune_order;?>" class="required">
			</td>
		</tr>
		<tr class=tr4>
			<td width="130">曝光率</td>
			<td align="left">
				<input type="text" name="item[exposure_rate]" value="<?php echo $item->exposure_rate;?>" class="required">
			</td>
		</tr>
		<tr class=tr4>
			<td width="130">曝光率排名</td>
			<td align="left">
				<input type="text" name="item[exposure_order]" value="<?php echo $item->exposure_order;?>">
			</td>
		</tr>
		<tr class=tr4>
			...
			<td align="left">
				...
				<span id="use_mr" style="cursor:pointer;">照片</span>
