<?php 
	...
	if($title){
		$tmp = "(b.title like '%$title%' or b.description like '%$title%' or b.short_title like '%$title%')";
		$c[] = $tmp;
	}	
...
<body>
<div id=icaption>
	<div id=title>文章内容管理</div>
	<a href="index.php" id=btn_back></a>
	<a href="news_edit.php?subject_id=<?php echo $subject_id;?>" id=btn_add></a>
</div>
<div id=isearch>
	...
	<table cellspacing="1"  align="center">
		...
		?>
				<tr class=tr3 id=<?php echo $items[$i]->item_id;?> >
					<td><?php echo strip_tags($items[$i]->$title_name);?></td>
					<td>
