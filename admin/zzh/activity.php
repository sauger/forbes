...
<div id=itable>
	<table cellspacing="1" align="center">
		...
		<tr class=itable_title>
			<td width="60%">活动名称</td><td width="10%">显示优先级</td><td width="30%">操作</td>
		</tr>
		<?php
			for($i=0;$i<$count;$i++){
		?>
				<tr class="tr3" id="<?php echo $record[$i]->id;?>">
					...
					<td>
						<a href="activity.edit.php?id=<?php echo $record[$i]->id;?>" class="edit" name="<?php echo $record[$i]->id;?>" style="cursor:pointer"><img src="/images/admin/btn_edit.png" border="0"></a>
		...
		?>
		<input type="hidden" id="db_table" value="zzh_activity">
			<tr class=btools>
				<td colspan=10>
