...
<div id=icaption>
    <div id=title>新闻管理</div>
	  <a href="/admin/news/news_edit.php" id=btn_add></a>
</div>
...
<div id=isearch>
	...
	<select id=up name="up" style="width:90px" class="sau_search" style="display:none">
...
<div id=itable>
	<table cellspacing="1"  align="center">
		...
		<tr class=tr3 id=<?php echo $record[$i]->id;?> >
			...
			<td>
				<a href="/admin/news/news_edit.php?id=<?php echo $record[$i]->id;?>" class="edit" name="<?php echo $record[$i]->id;?>" title="编辑"><img src="/images/admin/btn_edit.png" border="0"></a>　
