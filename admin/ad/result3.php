...
<div id=itable>
	<table cellspacing="1" align="center">
		<tr class=itable_title>
			<td width="30%">频道-广告位名</td><td width="20%">展示次数</td><td width="20%">有效次数</td><td width="15%">有效率</td><td width="15%">操作</td>
		</tr>
		<?php
			for($i=0;$i<$count;$i++){
		...
		<tr class=tr3 id="<?php echo $ad[$i]->id;?>">
			...
			<td>
				<a href="more_result3.php?id=<?php echo $record[$i]->source_id;?>&url=list" class="edit" title="详细" style="cursor:pointer"><img src="/images/admin/btn_edit.png" border="0"></a>
			</td>
		</tr>
		<?php }?>
		<tr class="btools">
...
<script>
	...
	function search(){
		window.location.href = "result3.php?key="+encodeURI($("#key").val())+"&date="+$(".date_jquery").val()+"&type="+$("#date_type").val();
	}
