<?php
	...
	$news = $db->query("select * from fb_investor_news where investor_id=$id");
...
<head>
	...
	<?php
		...
		use_jquery();
		js_include_tag('category_class','admin/investor');
...
<div id=itable>
	<table cellspacing="1" align="center">
		...
		?>
		<tr class="btools">
			<td colspan=10><?php paginate();?><input type="hidden" id="list_id" value="<?php echo $id?>"></td>
		</tr>
	</table>
</div>
</body>
