<?php 
	...
	$nav=$nav[0]->id;		
	$seo=$db->query('select * from fb_seo where name="生活首页"');	
?>
  ...
  <div id=life_bottom_left>
      ...
      <div class=life_box>
 				<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("服饰钟表")->id)?>
					<a href="<?php echo $url?>" class=more target="_blank"></a>
				</div>
      ...
      <div class=life_box>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("豪车")->id)?>
      ...
      <div class=life_box>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("游艇飞机")->id)?>
					<a href="<?php echo $url?>" class=more></a> 
				</div>	
			...
			<div id=life_ml>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("名利场")->id)?>
					<a href="<?php echo $url?>" class=more></a> 
				</div>	
				...
				<div id=content <?php show_page_pos($pos_name,'life_index')?>>
      ...
      <div class=life_box>
 				<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("美酒美食")->id)?>
					<a href="<?php echo $url?>" class=more></a> 
				</div>
      ...
      <div class=life_box>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("体面")->id)?>
					<a href="<?php echo $url?>" class=more></a>     	
				</div>	
      ...
      <div class=life_box>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("文化娱乐")->id)?>
					<a href="<?php echo $url?>" class=more></a> 
				</div>	
  ...
  <div id=life_bottom_right>
      ...
      <div class=life_box2 <?php show_page_pos($pos_name,'life_index')?>>
			...
			<div class=life_box2>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("关注")->id)?>
					<a href="<?php echo $url?>" class=more></a> 
				</div>
				<div id=line></div>
				...
				?>
				<div id=list <?php show_page_pos($pos_name,'life_index');?>>
					<?php show_page_href()?>
				</div>
				<?php }?>
			</div>
      ...
      <div class=life_box2>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("生活")->id)?>
					<a href="<?php echo $url?>" class=more></a> 
				</div>	
      ...
      <div class=life_box2>
  			<div class=life_caption>
					...
					<div class=line>|</div>
					<?php $url = get_newslist_url($category->find_by_name("慈善")->id)?>
					<a href="<?php echo $url?>" class=more></a> 
				</div>	
